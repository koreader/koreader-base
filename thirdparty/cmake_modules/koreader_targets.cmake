...
function(setup_target NAME)
    ...
    if(${NAME}_VISIBILITY)
        set(VISIBILITY ${${NAME}_VISIBILITY})
        if(VISIBILITY STREQUAL "inline-hidden")
            set_target_properties(${NAME} PROPERTIES VISIBILITY_INLINES_HIDDEN TRUE)
            set(VISIBILITY "hidden")
        endif()
        set_target_properties(${NAME} PROPERTIES C_VISIBILITY_PRESET ${VISIBILITY} CXX_VISIBILITY_PRESET ${VISIBILITY})
    endif()
...
# blitbuffer
if(ANDROID OR CERVANTES OR KINDLE OR POCKETBOOK OR REMARKABLE OR SONY_PRSTUX OR USE_SDL)

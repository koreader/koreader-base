...
describe("Blitbuffer unit tests", function()
    describe("Color conversion", function()
        ...
        it("should have pure white stay pure white when converting", function()
            print("Converting from RGB32")
        ...
        it("should have pure black stay pure black when converting", function()
            print("Converting from RGB32")
        ...
        it("should have non-pure white stay non-pure white when converting", function()
            print("Converting from RGB32")
            ...
            -- These ones do fail and may need fixing

...
-- Specialized variant for funky devices with an unreliable ioctl, where we're hopinh doing this in pairs like Nickel *might* help...
...
--       Which makes sense, as we've seen these reproduced in Nickel...

...
fz_stream *mupdf_open_memory(fz_context *, const unsigned char *, unsigned int);
...
const fz_color_params *fz_default_color_params(fz_context *);
fz_device *mupdf_new_draw_device(fz_context *, fz_matrix, fz_pixmap *);
fz_device *mupdf_new_text_device(fz_context *, fz_stext_page *, const fz_stext_options *);
fz_device *mupdf_new_bbox_device(fz_context *, fz_rect *);
void *mupdf_run_page(fz_context *, fz_page *, fz_device *, fz_matrix, fz_cookie *);

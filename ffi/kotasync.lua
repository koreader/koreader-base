...
local XZ_INDEX_MAXSIZE = 24 * 1024 * 1024
local XZ_INDEX_MEMLIMIT = 120 * 1024 * 1024
...
function TarXz:reorder(older_tar_xz_or_manifest_path)
    ...
    if older_tar_xz_or_manifest_path:match("[.]kotasync$") then
        ...
        local older_tar_xz = TarXz:new(older_tar_xz_or_manifest_path)
